...
import { insertOrder, isOrderAlreadyExist, updateStock } from './order.service';
...
const createOrder = async (req: Request, res: Response) => {
    try {
        ...
        const orderAlreadyExist = await isOrderAlreadyExist(orderData.product, orderData.email);
